          ...
          <Card.Body>
            ...
            <Card.Text as="div">
              ...
              <p>
                ...
                <Badge bg={Number(user.user_status_id) === 3 ? "danger" : user.user_status_id === 2 ? "info" : "secondary"}>
                  {Number(user.user_status_id) === 3 ? "Admin" : user.user_status_id === 2 ? "Organisateur" : "Utilisateur"}
                </Badge>
              </p>
            </Card.Text>
            {user.is_premium ? (
